...
*NOOBJ   ---  DIALECT"ENTCOBOL"   ---  COPYEXT"cpy,cbl"   ---  SOURCETABSTOP"4"   ---  COLLECTION"BANKTEST"  ---  NOCOBOLDIR   ---  MAX-ERROR"100"   ---  LIST()  ---   NOPANVALET NOLIBRARIAN   ---  WARNING"1"   ---  EXITPROGRAM"GOBACK"    --- SOURCEFORMAT"fixed"   ---  CHARSET"EBCDIC"  ---   CICSECM()  ---   ANIM   ---  ERRFORMAT(2)   ---  NOQUERY  ---   NOERRQ    --- STDERR*
